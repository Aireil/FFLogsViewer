...
public class Configuration : IPluginConfiguration
{
    ...
    private static List<LayoutEntry> GetDefaultLayout()
    {
        return new List<LayoutEntry>
        {
            ...
            new() { Type = LayoutEntryType.Encounter, Expansion = "Endwalker", Zone = "Abyssos", ZoneId = 49, Encounter = "Hephaistos II", EncounterId = 87, Difficulty = "Savage", DifficultyId = 101, SwapId = "6.2", SwapNumber = 0 },
