...
public class Configuration : IPluginConfiguration
{
    ...
    private static List<LayoutEntry> GetDefaultLayout()
    {
        return
        [
            new LayoutEntry { Type = LayoutEntryType.Header, Alias = "ACC C", Expansion = "-", Zone = "-", Encounter = "-", Difficulty = "-", SwapId = "7.2", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Cruiserweight", ZoneId = 68, Encounter = "Dancing Green", EncounterId = 97, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Cruiserweight", ZoneId = 68, Encounter = "Sugar Riot", EncounterId = 98, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Cruiserweight", ZoneId = 68, Encounter = "Brute Abombinator", EncounterId = 99, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Cruiserweight", ZoneId = 68, Encounter = "Howling Blade", EncounterId = 100, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Header, Alias = "ACC L-H", Expansion = "-", Zone = "-", Encounter = "-", Difficulty = "-", SwapId = "7.2", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Light-heavyweight", ZoneId = 62, Encounter = "Black Cat", EncounterId = 93, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Light-heavyweight", ZoneId = 62, Encounter = "Honey B. Lovely", EncounterId = 94, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Light-heavyweight", ZoneId = 62, Encounter = "Brute Bomber", EncounterId = 95, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Light-heavyweight", ZoneId = 62, Encounter = "Wicked Thunder", EncounterId = 96, Difficulty = "Normal", DifficultyId = 101, SwapId = "7.2", SwapNumber = 0 },
